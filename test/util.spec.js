...
import { licenseFileName, licenseFilesTargetFolder, sourceToTargetFilename } from '../lib/util.js';

describe('util', () => {
  describe('sourceToTargetFilename without targetDirectory', () => {
    it('should generate target filename from absolute path', () => {
      const target = sourceToTargetFilename('/absolute/path/to/sourceToTargetFilename.json');
    ...
    it('should generate target filename from relative path', () => {
      const target = sourceToTargetFilename('relative/path/to/sourceToTargetFilename.json');
    ...
    it('should throw generating target filename from empty string', () => {
      const generateFilenameFromEMptyString = () => { sourceToTargetFilename(''); };
  ...
  describe('sourceToTargetFilename with targetDirectory', () => {
    it('should generate target filename from absolute path', () => {
      const target = sourceToTargetFilename('/absolute/path/to/sourceToTargetFilename.json', '/target/path');
    ...
    it('should generate target filename from relative path', () => {
      const target = sourceToTargetFilename('relative/path/to/sourceToTargetFilename.json', 'target/path');
      const expectedTarget = path.join('target/path', 'sourceToTargetFilename.ext.json');
  ...
  describe('licenseFilesTargetFolder', () => {
    it('should return entered licenseDirectory', () => {
      ...
      const dir = licenseFilesTargetFolder(licenseDirectory, sourceDir);
  ...
  describe('licenseFileName', () => {
    it('should return filename with version', () => {
      const fileNameComponents = licenseFileName('package', '1.2.3');
    ...
    it('should return scope and filename with version', () => {
      const fileNameComponents = licenseFileName('@test/package-test', '2.3.4');
